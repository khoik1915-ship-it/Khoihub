...
local promptConnection, renderConnection, noclipConnection
...
separator.Size, separator.Position, separator.BackgroundColor3, separator.BorderSizePixel = UDim2.new(0, 2, 1, -20), UDim2.new(0, 156, 0, 10), Color3.fromRGB(50, 50, 50), 0
